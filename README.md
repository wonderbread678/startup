...
- [x] **Stores data in MongoDB** - Profiles, entries, and lists all stored in MongoDB from my database.js.
- [x] **Stores credentials in MongoDB** - Users and their authorization are stored in MongoDB.

## 🚀 WebSocket deliverable

For this deliverable I did the following. I checked the box `[x]` and added a description for things I completed.

- [x] **Backend listens for WebSocket connection** - Backend is managed in service/uploadMessenger.js.
