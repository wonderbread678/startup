...
export function About() {
  return (
    <main className="aboutMain">
      <div>
        <img className="aboutImg" src="https://thumbs.dreamstime.com/b/row-vintage-books-background-web-banner-free-copy-space-reading-education-literature-book-fair-concept-170940371.jpg" alt="aboutBanner" />
            <div id="about">
                <h2>~ About us ~</h2>
